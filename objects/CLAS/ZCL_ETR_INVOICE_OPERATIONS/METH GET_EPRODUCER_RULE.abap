  METHOD get_eproducer_rule.
    ...
    IF sy-subrc = 0 AND iv_rule_type = 'P' AND rs_rule_output-excld = abap_false.
      rs_rule_output-pidou = 'EABELGE'.
      rs_rule_output-ityou = 'MUSTAHSIL'.
    ENDIF.
  ENDMETHOD.